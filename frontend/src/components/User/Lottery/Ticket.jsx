...
import icon from '../../../assets/lottery/icon1.png';
				...
				<div className='grid grid-cols-12 px-2 py-4'>
					<div className='absolute win '>
						<div className='flex flex-col mx-auto space-y-3'>
							...
							<small className=' text-[0.5rem] text-slate-900 font-bold'>
								Next draw: {formatDate(next_draw_date) + ' ' + next_draw_time}
							</small>
						</div>
					</div>
					<div className='flex flex-col justify-between col-span-8 px-2 space-y-4'>
						...
						<img src={icon} alt='1xLuck Icon' className='w-10 ' />
						<small className='font-semibold text-gray-700'>
							Price: &#8705;{price}
						</small>
					</div>
					<div className='flex flex-col items-center justify-center col-span-4'>
						...
						<h2 className='text-xl font-semibold flex flex-col text-orange-300'>
							&#8705;{Number(firstPrize).toLocaleString()}
						</h2>
					</div>
				</div>
